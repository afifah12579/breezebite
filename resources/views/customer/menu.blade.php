    ...
    <div id="menu-containers">
        ...
        <div id="section-drinks" class="menu-section grid grid-cols-2 gap-4 hidden">
            @forelse($drinks as $item)
                <a href="{{ route('customer.showItem', $item->id) }}" class="group bg-white rounded-3xl p-3 border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-full w-full box-border block">
                    <div>
